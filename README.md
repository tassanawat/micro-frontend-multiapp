...
2. Move into the project directory and install the dependencies of each micro frontend 
    ...
    cd egp-seed-shell-mfe-web
    npm i
    cd egp-seed-sub-mfe-web
    npm i
    cd angular-mfe
    npm i
    cd react-mfe
...
3. Start the container egp-seed-shell-mfe-web (Port 4200) app first then other micro fronends like angular-mfe (Port 4201),egp-seed-sub-mfe-web (Port 4202), react-mfe (Port 4204).
...
1. Install ``@angular-architects/module-federation`` into the conatiner and into the micro frontend:
    ...
    ```
        npm i @angular-architects/module-federation@14.3.10
    ...
    ```
    npm i @angular-architects/module-federation-tools@14.3.10
    ```
...
1. Start the ``egp-seed-shell-mfe-web``, ``anegp-seed-sub-mfe-web``,  ``angular-mfe`` and ``react-mfe`` side by side in HOME Path:

    ```
    ng serve egp-seed-shell-mfe-web -o
    ng serve egp-seed-sub-mfe-web -o
